...
// node_modules/@remixproject/plugin-webview/src/lib/connector.js
var require_connector = __commonJS({
  "node_modules/@remixproject/plugin-webview/src/lib/connector.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createClient = exports.WebviewConnector = void 0;
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    var plugin_1 = require_src();
    var axios_1 = require_axios2();
    function toKebabCase(text) {
      return text.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g, "$1-$2").toLowerCase();
    }
    var WebviewConnector = class {
      constructor(options) {
        this.options = options;
        try {
          this.isVscode = acquireTheiaApi !== void 0;
        ...
        window.addEventListener("message", (event) => tslib_1.__awaiter(this, void 0, void 0, function* () {
          ...
          if (event.origin.indexOf("vscode-webview:") > -1) {
            ...
            if (event.data.action && event.data.action === "copy") {
              ...
              window.parent.postMessage(event2, "*");
              return;
            }
          }
    ...
    function listenOnThemeChanged(client) {
      return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        client.onload(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
          client.on("theme", "themeChanged", (theme2) => {
            setLink(theme2);
            applyTheme(theme2);
          });
...
// node_modules/@remixproject/plugin-webview/src/index.js
var require_src2 = __commonJS({
  "node_modules/@remixproject/plugin-webview/src/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
...
//# sourceMappingURL=@remixproject_plugin-webview.js.map
